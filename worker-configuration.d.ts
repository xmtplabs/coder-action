/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5dbce8820a1ff904095af34260664a37)
// Runtime types generated with workerd@1.20260415.1 2026-04-18 nodejs_compat
export {};
declare global {
	const AGENT_GITHUB_USERNAME: "xmtp-coder-agent";
	const CODER_URL: "https://coder.example.com";
	const CODER_TASK_NAME_PREFIX: "gh";
	const CODER_TEMPLATE_NAME: "task-template";
	const CODER_TEMPLATE_NAME_CODEX: "task-template-codex";
	const CODER_ORGANIZATION: "default";
	const LOG_FORMAT: "json";
	const CODER_TASK_WORKFLOW: Workflow /* CoderTaskWorkflow */;
}
