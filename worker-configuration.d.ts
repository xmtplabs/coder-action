...
declare namespace Cloudflare {
	...
	interface Env {
		...
		LOG_FORMAT: "json";
		REPO_CONFIG_DO: DurableObjectNamespace<import("./src/main").RepoConfigDO>;
		TASK_RUNNER_WORKFLOW: Workflow<Parameters<import("./src/main").TaskRunnerWorkflow['run']>[0]['payload']>;
		REPO_CONFIG_WORKFLOW: Workflow<Parameters<import("./src/main").RepoConfigWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AGENT_GITHUB_USERNAME" | "CODER_URL" | "CODER_TASK_NAME_PREFIX" | "CODER_TEMPLATE_NAME" | "CODER_TEMPLATE_NAME_CODEX" | "CODER_ORGANIZATION" | "LOG_FORMAT">> {}
}
